...
- [ ] 3.1 Escrever as seções de declaração do problema e arquitetura, verificar contra a arquitetura de fato implementada (não o plano original, caso tenham divergido)
- [ ] 3.2 Inserir a tabela comparativa de métricas da fase-2/fase-3, verificar que os números batem com a saída da última rodada de avaliação
