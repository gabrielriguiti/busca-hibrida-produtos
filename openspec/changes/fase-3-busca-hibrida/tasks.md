...
- [x] 2.2 Adicionar o modo híbrido ao endpoint de busca devolvendo resultados fundidos com scores lexical/vetorial por resultado, verificar com uma chamada curl manual
